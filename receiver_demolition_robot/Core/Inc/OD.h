...
********************************************************************************
    ...
    File info:
        ...
        Created:      11/23/2020 11:00:00 AM
        Created By:   
        Modified:     3/16/2026 7:08:06 PM
        Modified By:  
...
typedef struct {
    ...
    uint8_t x2000_controlData_sub0;
    uint8_t x2000_controlData[8];
} OD_RAM_t;
...
#define OD_ENTRY_H2000_controlData &OD->list[33]
#define OD_ENTRY_H6000_velocity &OD->list[34]

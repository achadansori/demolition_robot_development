...
bool NRF24_Configure(void)
{
    ...
    // Enable Auto-ACK on pipe 0 to match transmitter (Enhanced ShockBurst).
    // On the PRX side the ACK is generated by hardware, so it adds no MCU
    // SPI busy-wait and does not disturb the ADC DMA.
